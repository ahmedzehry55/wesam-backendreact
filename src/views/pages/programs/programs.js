...
export default function programs() {
  ...
  useEffect(() => {
    fetch('http://wesamelnagah.com:4000/api/aprogrammes')
      .then((res) => res.json())
      .then((data) => {
        setData(data.data)
      })
  ...
  const deletehandle = async (e, { id }) => {
    e.preventDefault()
    try {
      await axios.delete(`http://wesamelnagah.com:4000/api/aprogrammes/${id}`)
    } catch (e) {
      console.log(e)
    }
  }
          ...
          <CTable>
            <CTableHead>
              <CTableRow>
                ...
                <CTableHeaderCell scope="col">الدولة</CTableHeaderCell>
